...
func NewHeliosExchangeRPCClient(cc grpc.ClientConnInterface) HeliosExchangeRPCClient {
	return &ExchangeRPCClient{cc}
}

func (c *ExchangeRPCClient) GetTx(ctx context.Context, in *GetTxRequest, opts ...grpc.CallOption) (*GetTxResponse, error) {
	out := new(GetTxResponse)
	err := c.cc.Invoke(ctx, "/_exchange_rpc.HeliosExchangeRPC/GetTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ExchangeRPCClient) PrepareTx(ctx context.Context, in *PrepareTxRequest, opts ...grpc.CallOption) (*PrepareTxResponse, error) {
	out := new(PrepareTxResponse)
	err := c.cc.Invoke(ctx, "/_exchange_rpc.HeliosExchangeRPC/PrepareTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ExchangeRPCClient) BroadcastTx(ctx context.Context, in *BroadcastTxRequest, opts ...grpc.CallOption) (*BroadcastTxResponse, error) {
	out := new(BroadcastTxResponse)
	err := c.cc.Invoke(ctx, "/_exchange_rpc.HeliosExchangeRPC/BroadcastTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ExchangeRPCClient) PrepareCosmosTx(ctx context.Context, in *PrepareCosmosTxRequest, opts ...grpc.CallOption) (*PrepareCosmosTxResponse, error) {
	out := new(PrepareCosmosTxResponse)
	err := c.cc.Invoke(ctx, "/_exchange_rpc.HeliosExchangeRPC/PrepareCosmosTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ExchangeRPCClient) BroadcastCosmosTx(ctx context.Context, in *BroadcastCosmosTxRequest, opts ...grpc.CallOption) (*BroadcastCosmosTxResponse, error) {
	out := new(BroadcastCosmosTxResponse)
	err := c.cc.Invoke(ctx, "/_exchange_rpc.HeliosExchangeRPC/BroadcastCosmosTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ExchangeRPCClient) GetFeePayer(ctx context.Context, in *GetFeePayerRequest, opts ...grpc.CallOption) (*GetFeePayerResponse, error) {
	out := new(GetFeePayerResponse)
	err := c.cc.Invoke(ctx, "/_exchange_rpc.HeliosExchangeRPC/GetFeePayer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HeliosExchangeRPC_GetTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_exchange_rpc.HeliosExchangeRPC/GetTx",
	}
...
func _HeliosExchangeRPC_PrepareTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_exchange_rpc.HeliosExchangeRPC/PrepareTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HeliosExchangeRPC_BroadcastTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_exchange_rpc.HeliosExchangeRPC/BroadcastTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HeliosExchangeRPC_PrepareCosmosTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_exchange_rpc.HeliosExchangeRPC/PrepareCosmosTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HeliosExchangeRPC_BroadcastCosmosTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_exchange_rpc.HeliosExchangeRPC/BroadcastCosmosTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HeliosExchangeRPC_GetFeePayer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_exchange_rpc.HeliosExchangeRPC/GetFeePayer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var HeliosExchangeRPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "_exchange_rpc.HeliosExchangeRPC",
