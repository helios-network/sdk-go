...
func (c *MetaRPCClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	out := new(PingResponse)
	err := c.cc.Invoke(ctx, "/_meta_rpc.HeliosMetaRPC/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *MetaRPCClient) Version(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionResponse, error) {
	out := new(VersionResponse)
	err := c.cc.Invoke(ctx, "/_meta_rpc.HeliosMetaRPC/Version", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *MetaRPCClient) Info(ctx context.Context, in *InfoRequest, opts ...grpc.CallOption) (*InfoResponse, error) {
	out := new(InfoResponse)
	err := c.cc.Invoke(ctx, "/_meta_rpc.HeliosMetaRPC/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *MetaRPCClient) StreamKeepalive(ctx context.Context, in *StreamKeepaliveRequest, opts ...grpc.CallOption) (HeliosMetaRPC_StreamKeepaliveClient, error) {
	stream, err := c.cc.NewStream(ctx, &HeliosMetaRPC_ServiceDesc.Streams[0], "/_meta_rpc.HeliosMetaRPC/StreamKeepalive", opts...)
	if err != nil {
		return nil, err
	}
	x := &MetaRPCStreamKeepaliveClient{stream}
...
type MetaRPCStreamKeepaliveClient struct {
	grpc.ClientStream
}

func (x *MetaRPCStreamKeepaliveClient) Recv() (*StreamKeepaliveResponse, error) {
...
func (c *MetaRPCClient) TokenMetadata(ctx context.Context, in *TokenMetadataRequest, opts ...grpc.CallOption) (*TokenMetadataResponse, error) {
	out := new(TokenMetadataResponse)
	err := c.cc.Invoke(ctx, "/_meta_rpc.HeliosMetaRPC/TokenMetadata", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HeliosMetaRPC_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_meta_rpc.HeliosMetaRPC/Ping",
	}
...
func _HeliosMetaRPC_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_meta_rpc.HeliosMetaRPC/Version",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HeliosMetaRPC_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_meta_rpc.HeliosMetaRPC/Info",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HeliosMetaRPC_StreamKeepalive_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(HeliosMetaRPCServer).StreamKeepalive(m, &MetaRPCStreamKeepaliveServer{stream})
}
...
type MetaRPCStreamKeepaliveServer struct {
	grpc.ServerStream
}

func (x *MetaRPCStreamKeepaliveServer) Send(m *StreamKeepaliveResponse) error {
...
func _HeliosMetaRPC_TokenMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_meta_rpc.HeliosMetaRPC/TokenMetadata",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var HeliosMetaRPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "_meta_rpc.HeliosMetaRPC",
