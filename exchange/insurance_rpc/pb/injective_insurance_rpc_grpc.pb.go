...
type InsuranceRPCClient struct {
	cc grpc.ClientConnInterface
}

func NewHeliosInsuranceRPCClient(cc grpc.ClientConnInterface) HeliosInsuranceRPCClient {
	return &InsuranceRPCClient{cc}
}

func (c *InsuranceRPCClient) Funds(ctx context.Context, in *FundsRequest, opts ...grpc.CallOption) (*FundsResponse, error) {
	out := new(FundsResponse)
	err := c.cc.Invoke(ctx, "/_insurance_rpc.HeliosInsuranceRPC/Funds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *InsuranceRPCClient) Redemptions(ctx context.Context, in *RedemptionsRequest, opts ...grpc.CallOption) (*RedemptionsResponse, error) {
	out := new(RedemptionsResponse)
	err := c.cc.Invoke(ctx, "/_insurance_rpc.HeliosInsuranceRPC/Redemptions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HeliosInsuranceRPC_Funds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_insurance_rpc.HeliosInsuranceRPC/Funds",
	}
...
func _HeliosInsuranceRPC_Redemptions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_insurance_rpc.HeliosInsuranceRPC/Redemptions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var HeliosInsuranceRPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "_insurance_rpc.HeliosInsuranceRPC",
