...
//
// HeliosOracleRPC protocol buffer definition
//
// Command:
...
var file_goadesign_goagen_helios_oracle_rpc_proto_depIdxs = []int32{
	...
	0, // 1: helios_oracle_rpc.HeliosOracleRPC.OracleList:input_type -> helios_oracle_rpc.OracleListRequest
	3, // 2: helios_oracle_rpc.HeliosOracleRPC.Price:input_type -> helios_oracle_rpc.PriceRequest
	5, // 3: helios_oracle_rpc.HeliosOracleRPC.StreamPrices:input_type -> helios_oracle_rpc.StreamPricesRequest
	7, // 4: helios_oracle_rpc.HeliosOracleRPC.StreamPricesByMarkets:input_type -> helios_oracle_rpc.StreamPricesByMarketsRequest
	1, // 5: helios_oracle_rpc.HeliosOracleRPC.OracleList:output_type -> helios_oracle_rpc.OracleListResponse
	4, // 6: helios_oracle_rpc.HeliosOracleRPC.Price:output_type -> helios_oracle_rpc.PriceResponse
	6, // 7: helios_oracle_rpc.HeliosOracleRPC.StreamPrices:output_type -> helios_oracle_rpc.StreamPricesResponse
	8, // 8: helios_oracle_rpc.HeliosOracleRPC.StreamPricesByMarkets:output_type -> helios_oracle_rpc.StreamPricesByMarketsResponse
