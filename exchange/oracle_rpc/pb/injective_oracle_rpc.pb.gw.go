...
func RegisterInjectiveOracleRPCHandlerServer(ctx context.Context, mux *runtime.ServeMux, server InjectiveOracleRPCServer) error {
	...
	mux.Handle("POST", pattern_InjectiveOracleRPC_OracleList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/helios_oracle_rpc.InjectiveOracleRPC/OracleList", runtime.WithHTTPPathPattern("/helios_oracle_rpc.InjectiveOracleRPC/OracleList"))
		if err != nil {
	...
	mux.Handle("POST", pattern_InjectiveOracleRPC_Price_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/helios_oracle_rpc.InjectiveOracleRPC/Price", runtime.WithHTTPPathPattern("/helios_oracle_rpc.InjectiveOracleRPC/Price"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterInjectiveOracleRPCHandlerClient(ctx context.Context, mux *runtime.ServeMux, client InjectiveOracleRPCClient) error {
	...
	mux.Handle("POST", pattern_InjectiveOracleRPC_OracleList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helios_oracle_rpc.InjectiveOracleRPC/OracleList", runtime.WithHTTPPathPattern("/helios_oracle_rpc.InjectiveOracleRPC/OracleList"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_InjectiveOracleRPC_Price_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helios_oracle_rpc.InjectiveOracleRPC/Price", runtime.WithHTTPPathPattern("/helios_oracle_rpc.InjectiveOracleRPC/Price"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_InjectiveOracleRPC_StreamPrices_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helios_oracle_rpc.InjectiveOracleRPC/StreamPrices", runtime.WithHTTPPathPattern("/helios_oracle_rpc.InjectiveOracleRPC/StreamPrices"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_InjectiveOracleRPC_StreamPricesByMarkets_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helios_oracle_rpc.InjectiveOracleRPC/StreamPricesByMarkets", runtime.WithHTTPPathPattern("/helios_oracle_rpc.InjectiveOracleRPC/StreamPricesByMarkets"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_InjectiveOracleRPC_OracleList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"helios_oracle_rpc.InjectiveOracleRPC", "OracleList"}, ""))

	pattern_InjectiveOracleRPC_Price_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"helios_oracle_rpc.InjectiveOracleRPC", "Price"}, ""))

	pattern_InjectiveOracleRPC_StreamPrices_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"helios_oracle_rpc.InjectiveOracleRPC", "StreamPrices"}, ""))

	pattern_InjectiveOracleRPC_StreamPricesByMarkets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"helios_oracle_rpc.InjectiveOracleRPC", "StreamPricesByMarkets"}, ""))
)
