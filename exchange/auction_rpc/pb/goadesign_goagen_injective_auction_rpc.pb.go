...
var file_goadesign_goagen_helios_auction_rpc_proto_depIdxs = []int32{
	...
	0, // 4: helios_auction_rpc.HeliosAuctionRPC.AuctionEndpoint:input_type -> helios_auction_rpc.AuctionEndpointRequest
	5, // 5: helios_auction_rpc.HeliosAuctionRPC.Auctions:input_type -> helios_auction_rpc.AuctionsRequest
	7, // 6: helios_auction_rpc.HeliosAuctionRPC.StreamBids:input_type -> helios_auction_rpc.StreamBidsRequest
	1, // 7: helios_auction_rpc.HeliosAuctionRPC.AuctionEndpoint:output_type -> helios_auction_rpc.AuctionEndpointResponse
	6, // 8: helios_auction_rpc.HeliosAuctionRPC.Auctions:output_type -> helios_auction_rpc.AuctionsResponse
	8, // 9: helios_auction_rpc.HeliosAuctionRPC.StreamBids:output_type -> helios_auction_rpc.StreamBidsResponse
