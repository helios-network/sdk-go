...
func RegisterInjectiveAuctionRPCHandlerServer(ctx context.Context, mux *runtime.ServeMux, server InjectiveAuctionRPCServer) error {
	...
	mux.Handle("POST", pattern_InjectiveAuctionRPC_AuctionEndpoint_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/helios_auction_rpc.InjectiveAuctionRPC/AuctionEndpoint", runtime.WithHTTPPathPattern("/helios_auction_rpc.InjectiveAuctionRPC/AuctionEndpoint"))
		if err != nil {
	...
	mux.Handle("POST", pattern_InjectiveAuctionRPC_Auctions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/helios_auction_rpc.InjectiveAuctionRPC/Auctions", runtime.WithHTTPPathPattern("/helios_auction_rpc.InjectiveAuctionRPC/Auctions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterInjectiveAuctionRPCHandlerClient(ctx context.Context, mux *runtime.ServeMux, client InjectiveAuctionRPCClient) error {
	...
	mux.Handle("POST", pattern_InjectiveAuctionRPC_AuctionEndpoint_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helios_auction_rpc.InjectiveAuctionRPC/AuctionEndpoint", runtime.WithHTTPPathPattern("/helios_auction_rpc.InjectiveAuctionRPC/AuctionEndpoint"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_InjectiveAuctionRPC_Auctions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helios_auction_rpc.InjectiveAuctionRPC/Auctions", runtime.WithHTTPPathPattern("/helios_auction_rpc.InjectiveAuctionRPC/Auctions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_InjectiveAuctionRPC_StreamBids_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helios_auction_rpc.InjectiveAuctionRPC/StreamBids", runtime.WithHTTPPathPattern("/helios_auction_rpc.InjectiveAuctionRPC/StreamBids"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_InjectiveAuctionRPC_AuctionEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"helios_auction_rpc.InjectiveAuctionRPC", "AuctionEndpoint"}, ""))

	pattern_InjectiveAuctionRPC_Auctions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"helios_auction_rpc.InjectiveAuctionRPC", "Auctions"}, ""))

	pattern_InjectiveAuctionRPC_StreamBids_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"helios_auction_rpc.InjectiveAuctionRPC", "StreamBids"}, ""))
)
