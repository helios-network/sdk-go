...
func main() {
	...
	namespaceDenom := "factory/helios1hkhdaj2a2clmq5jq6mspsggqs32vynpk228q3r/helios_test"

	msg := &permissionstypes.MsgUpdateNamespace{
		Sender:         senderAddress.String(),
		NamespaceDenom: namespaceDenom,
		WasmHook:       &permissionstypes.MsgUpdateNamespace_MsgSetWasmHook{NewValue: "helios19ld6swyldyujcn72j7ugnu9twafhs9wxlyye5m"},
