...
// source: /stream/v1beta1/query.proto
...
type SpotOrderUpdate struct {
	Status    OrderUpdateStatus `protobuf:"varint,1,opt,name=status,proto3,enum=.stream.v1beta1.OrderUpdateStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum(".stream.v1beta1.OrderUpdateStatus", OrderUpdateStatus_name, OrderUpdateStatus_value)
	proto.RegisterType((*StreamRequest)(nil), ".stream.v1beta1.StreamRequest")
	proto.RegisterType((*StreamResponse)(nil), ".stream.v1beta1.StreamResponse")
	proto.RegisterType((*OrderbookUpdate)(nil), ".stream.v1beta1.OrderbookUpdate")
	proto.RegisterType((*Orderbook)(nil), ".stream.v1beta1.Orderbook")
	proto.RegisterType((*BankBalance)(nil), ".stream.v1beta1.BankBalance")
	proto.RegisterType((*SubaccountDeposits)(nil), ".stream.v1beta1.SubaccountDeposits")
	proto.RegisterType((*SubaccountDeposit)(nil), ".stream.v1beta1.SubaccountDeposit")
	proto.RegisterType((*SpotOrderUpdate)(nil), ".stream.v1beta1.SpotOrderUpdate")
	proto.RegisterType((*SpotOrder)(nil), ".stream.v1beta1.SpotOrder")
	proto.RegisterType((*DerivativeOrderUpdate)(nil), ".stream.v1beta1.DerivativeOrderUpdate")
	proto.RegisterType((*DerivativeOrder)(nil), ".stream.v1beta1.DerivativeOrder")
	proto.RegisterType((*Position)(nil), ".stream.v1beta1.Position")
	proto.RegisterType((*OraclePrice)(nil), ".stream.v1beta1.OraclePrice")
	proto.RegisterType((*SpotTrade)(nil), ".stream.v1beta1.SpotTrade")
	proto.RegisterType((*DerivativeTrade)(nil), ".stream.v1beta1.DerivativeTrade")
	proto.RegisterType((*TradesFilter)(nil), ".stream.v1beta1.TradesFilter")
	proto.RegisterType((*PositionsFilter)(nil), ".stream.v1beta1.PositionsFilter")
	proto.RegisterType((*OrdersFilter)(nil), ".stream.v1beta1.OrdersFilter")
	proto.RegisterType((*OrderbookFilter)(nil), ".stream.v1beta1.OrderbookFilter")
	proto.RegisterType((*BankBalancesFilter)(nil), ".stream.v1beta1.BankBalancesFilter")
	proto.RegisterType((*SubaccountDepositsFilter)(nil), ".stream.v1beta1.SubaccountDepositsFilter")
	proto.RegisterType((*OraclePriceFilter)(nil), ".stream.v1beta1.OraclePriceFilter")
}

func init() {
	proto.RegisterFile("/stream/v1beta1/query.proto", fileDescriptor_e23b7dcfb2fbc9c7)
}
...
func (c *streamClient) Stream(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (Stream_StreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Stream_serviceDesc.Streams[0], "/.stream.v1beta1.Stream/Stream", opts...)
	if err != nil {
		return nil, err
	}
...
var _Stream_serviceDesc = grpc.ServiceDesc{
	ServiceName: ".stream.v1beta1.Stream",
	...
	Metadata: "/stream/v1beta1/query.proto",
}
