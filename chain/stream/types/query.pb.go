...
type SpotOrderUpdate struct {
	Status    OrderUpdateStatus `protobuf:"varint,1,opt,name=status,proto3,enum=helios.stream.v1beta1.OrderUpdateStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterFile("helios/stream/v1beta1/query.proto", fileDescriptor_e23b7dcfb2fbc9c7)
}
