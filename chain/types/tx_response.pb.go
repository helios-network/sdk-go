...
// source: /types/v1beta1/tx_response.proto
...
func init() {
	proto.RegisterType((*TxResponseGenericMessage)(nil), ".types.v1beta1.TxResponseGenericMessage")
	proto.RegisterType((*TxResponseData)(nil), ".types.v1beta1.TxResponseData")
}

func init() {
	proto.RegisterFile("/types/v1beta1/tx_response.proto", fileDescriptor_9122428102320deb)
}
