...
// NewInjectiveCoin is a utility function that returns an "helios" coin with the given math.Int amount.
// The function will panic if the provided amount is negative.
func NewInjectiveCoin(amount math.Int) sdk.Coin {
	return sdk.NewCoin(InjectiveCoin, amount)
}

// NewInjectiveCoinInt64 is a utility function that returns an "helios" coin with the given int64 amount.
// The function will panic if the provided amount is negative.
