...
import (
	...
	chaintypes "github.com/Helios-Chain-Labs/sdk-go/types"
)
...
func DefaultParams() Params {
	return Params{
		DenomCreationFee: sdk.NewCoins(sdk.NewCoin(chaintypes.HeliosCoin, math.NewIntWithDecimal(10, 18))), // 10 HELIOS
	}
}
