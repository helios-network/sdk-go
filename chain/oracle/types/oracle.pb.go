...
func init() {
	proto.RegisterFile("helios/oracle/v1beta1/oracle.proto", fileDescriptor_1c8fbf1e7a765423)
}
func init() {
	golang_proto.RegisterFile("helios/oracle/v1beta1/oracle.proto", fileDescriptor_1c8fbf1e7a765423)
}
